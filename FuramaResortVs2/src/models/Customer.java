...
public class Customer implements Comparable<Customer> {
    private String nameCustomer; // tên khách hàng
    private String dayOfBirth;// ngày sinh
    private String gender;// Giới tính
    private String cardNumber;// số cmnd
    ...
    public Customer() {  // contructor có tên trùng với tên class
    }

    public Customer(String nameCustomer, String dayOfBirth, String gender, String cardNumber, String phoneNumber,
