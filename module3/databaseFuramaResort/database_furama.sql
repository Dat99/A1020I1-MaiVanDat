...
-- 1.Thêm mới thông tin cho các table
...
insert into nhan_vien(id_nhan_vien, id_vi_tri, id_trinh_do, id_bo_phan, ngay_sinh,
                          so_cmnd,luong,so_dien_thoai,email,dia_chi,ho_va_ten )
values
('1','1','1','1','1999-03-11','12345689','700000','0916309250','dat@gmail.com','đà nẵng','mai van dat'),
...
insert into Khach_hang(id_khach_hang,id_loai_khach,ho_va_ten,ngay_sinh,so_cmnd,
                         sdt,email,dia_chi)
values
('1','1','Nguyễn thị thanh','1997-03-15','123456789','0916309250','thanh@gnail.com','Đà nẵng'),
...
-- thêm mới dịch vụ
insert into dich_vu(id_dich_vu,ten_dich_vu,dien_tich,so_tang,so_nguoi_toi_da,
                            chi_phi_thue,id_kieu_thue,id_loai_dich_vu,trang_thai)
values
('1','Villa 1','500','2','6','50000','1','2','còn phòng'),
...
-- thêm dịch vụ đi kèm
insert into dich_vu_di_kem(id_dich_vu_di_kem,ten_dich_vu,don_vi,gia_tien,trang_thai_kha_dung)
values
('1','Massage','người','200','còn trống'),
...
values
('1','1','1','1','2021-11-02','2021-11-07','5005','700000'),
...
('5','1','1','1','2021-11-02','2021-11-07','5005','700000'),
...
('9','1','6','1','2021-11-02','2021-11-07','5005','700000'),
('10','1','6','3','2021-11-02','2021-11-07','5005','700000'),
('11','2','6','1','2021-11-02','2021-11-07','5005','700000'),
('12','1','6','1','2018-11-02','2021-11-07','5005','700000'),
('13','1','6','3','2018-11-02','2021-11-07','5005','700000'),
('14','4','1','1','2019-11-02','2021-11-07','5005','700000'),
('15','3','2','3','2019-11-02','2021-11-07','5005','700000'),
('16','4','10','1','2019-11-02','2021-11-07','5005','700000'),
...
-- Kết quả hiển thị được sắp xếp tăng dần theo số 
...
-- TenLoaiDichVu của tất cả các loại Dịch vụ chưa từng được Khách hàng thực hiện đặt từ quý 1 của năm 2019 
